...
export const metadata={title:"Landed-Cost Calculator",description:"Simple pre-launch variable-cost and contribution-margin calculator for SaunaWhisks.com.",alternates:{canonical:"/tools/landed-cost"}};
