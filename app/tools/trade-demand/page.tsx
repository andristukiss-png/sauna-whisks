...
export const metadata={title:"Trade Demand Estimator",description:"Estimate monthly sauna-whisk demand for a public sauna, spa or wellness venue.",alternates:{canonical:"/tools/trade-demand"}};
