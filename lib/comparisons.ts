...
export const comparisons: Comparison[] = [
  {
    ...
    related: [{ label: "Baltic Birch", href: "/shop/baltic-birch" }, { label: "Latvian Oak", href: "/shop/latvian-oak" }]
  },
  {
  ...
  },
  {
    ...
    related: [{ label: "Latvian Oak", href: "/shop/latvian-oak" }, { label: "Eucalyptus", href: "/shop/eucalyptus" }]
  },
  {
    slug: "fresh-vs-dried",
