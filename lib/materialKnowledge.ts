...
export const materialKnowledge: MaterialKnowledge[] = [
  ...
  { slug: "oak", name: "Oak", latin: "Quercus", status: "Core launch material", summary: "A broader-leafed, denser material for a firmer ritual feel.", feel: "Firm and substantial", aroma: "Earthy / woody", notes: ["Broad leaves move air effectively", "Common in banya and Baltic assortments", "Species should be disclosed when verified"], relatedProduct: "/shop/baltic-oak" },
