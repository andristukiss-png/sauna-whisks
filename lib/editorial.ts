...
export const sourceHierarchy = [
  ...
  ["Named producers", "Product-specific harvesting, processing, preparation and specification claims."],
  ["Marketplaces / retailers", "Useful for observing commercial vocabulary and assortment, not for scientific or regulatory claims."],
] as const;
