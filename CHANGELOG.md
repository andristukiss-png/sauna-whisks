...
- market and trade-segment pages
- supplier intake and sample evaluation
- product standards, provenance and claims governance
- public JSON/CSV data endpoints
- enquiry flow with mail fallback
- validation/lint/typecheck/build CI
- checkout intentionally disabled

Commercial release versions will begin when the first verified SKUs and checkout are approved.
